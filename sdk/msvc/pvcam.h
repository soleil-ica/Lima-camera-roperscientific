...
#ifndef _PVCAM_H
#define _PVCAM_H
static const char *_pvcam_h_="$Header: /PVCAM V2.6/SourceCommon/pvcam.h   20   2010-10-13 14:12:21-04:00   dtrent $";
...
#define PARAM_CAMERA_TYPE           ((CLASS2<<16) + (TYPE_INT32<<24)     + 350)

/* Pixel Bias Correction Enable/Disable for Common Platform */
#define PARAM_PBC                   ((CLASS2<<16) + (TYPE_ENUM<<24)      + 351)

/* SKIP_SREG_CLEAN */
#define PARAM_SKIP_SREG_CLEAN       ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 330)
...
#define PARAM_CLN_WHILE_EXPO        ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 352)   

/* PreExpose (actually after reading out) Cleans                             */
#define PARAM_PREEXP_CLEANS         ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 354)
...
#define PARAM_LOGIC_OUTPUT_INVERT   ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 548)
...
#define PARAM_TG_OPTION_BD_TYPE     ((CLASS2<<16) + (TYPE_ENUM<<24)      + 353)
...
#define PARAM_HEAD_COOLING_CTRL     ((CLASS2<<16) + (TYPE_ENUM<<24)      + 338)
#define PARAM_COOLING_FAN_CTRL      ((CLASS2<<16) + (TYPE_ENUM<<24)      + 339)
...
#define PARAM_PAR_SHIFT_INDEX       ((CLASS2<<16) + (TYPE_UNS32<<24)     + 547)
...
#define PARAM_SHTR_CLOSE_DELAY_UNIT ((CLASS2<<16) + (TYPE_ENUM <<24)     + 543)
#define PARAM_SHTR_RES              ((CLASS2<<16) + (TYPE_ENUM <<24)     + 343)
...
#define PARAM_DIAG                  ((CLASS2<<16) + (TYPE_UNS32<<24)     + 180)
#define PARAM_DIAG_P1               ((CLASS2<<16) + (TYPE_UNS32<<24)     + 181)
#define PARAM_DIAG_P2               ((CLASS2<<16) + (TYPE_UNS32<<24)     + 182)
#define PARAM_DIAG_P3               ((CLASS2<<16) + (TYPE_UNS32<<24)     + 183)
#define PARAM_DIAG_P4               ((CLASS2<<16) + (TYPE_UNS32<<24)     + 184)
#define PARAM_DIAG_P5               ((CLASS2<<16) + (TYPE_UNS32<<24)     + 185)
...
#define PARAM_HW_AUTOSTOP32         ((CLASS3<<16) + (TYPE_INT32<<24)     + 166)
...
enum /* PARAM_HEAD_COOLING_CTRL */
{
  HEAD_COOLING_CTRL_NA = 0, /* Not Available */
  HEAD_COOLING_CTRL_ON,     /* Turn ON the head cooling */
  HEAD_COOLING_CTRL_OFF     /* Turn OFF the head cooling */
};

enum /* PARAM_COOLING_FAN_CTRL */
{
  COOLING_FAN_CTRL_NA = 0,  /* Not Available */
  COOLING_FAN_CTRL_ON,      /* Enable the cooling fan */
  COOLING_FAN_CTRL_OFF      /* Disable the cooling fan */
};
...
enum OPTN_BD_SPEC       
{
  ...
  OPTN_BD_PTG_FAST_GATE,           /* PTG Fast gate bd                       */
  OPTN_BD_SS_FAST_GATE,            /* SuperSynchro Fast Gate bd.             */
  OPTN_BD_SS_RF_MOD,               /* SuperSynchro RF modulation bd.         */

  OPTN_BD_FOR_SPR = 100,
  OPTN_BD_SPR_3917,                /* SPR-3917                               */
...
enum
{ SHTR_RES_100_NANO_SEC = 1, SHTR_RES_100_MICRO_SEC, SHTR_RES_1_MILLI_SEC };
...
/* used with the PARAM_EXPOSURE_MODE parameter id.                            
  ...
  PI Conversion:
         ...
         Readout Mode: Normal           ROM_KINETICS              ROM_DIF                     
                                        ROM_SPECTRA_KINETICS
  -----------------------------------------------------------------------------------------
                       PMODE_NORMAL     PMODE_KINETICS            PMODE_DIF                   
                       PMODE_FT         PMODE_SPECTRA_KINETICS
                       PMODE_INTERLINE
                                                                  PI-Max II     PI-Max(org)
                                                                  PI-Max 3
  -----------------------------------------------------------------------------------------
            BULB_MODE: CTRL_BULB                                  CTRL_DIF_STM  CTRL_EEC
