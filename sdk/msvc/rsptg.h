...
/* General parameters      */
/* ####################### */
/* Time Units, This sets the timeunits for whole plugin, Note: if this is   */
/* changed all units should be resent to PTG.                               */
#define PARAM_PTG_TIME_UNITS ((CLASS94 << 16) + (TYPE_ENUM << 24) + 22)
/* Board temperature, read only in Celsius.                                 */
...
/* Internal frequency, this is in Hz (this is only for internal trigger)    */
...
/* Gate Width (default 1.0 usec, min 0.0, max 26 ms, resolution 0.04nsec)   */
#define PARAM_PTG_PULSE_WIDTH ((CLASS94 << 16) + (TYPE_FLT64 << 24) + 21)
/* Gate Delay (default 1.0 usec, min 3.125ns, max 26 ms, res 0.04nsec)      */
#define PARAM_PTG_PULSE_DELAY ((CLASS94 << 16) + (TYPE_FLT64 << 24) + 23)
/* Auc Delay (default 0.0, min 0.0, max 26 ms, resolution 0.04nsec)         */
...
{
  PTG_USE_INTERNAL_TRIG = 0,
  PTG_USE_EXTERNAL_TRIG,
  PTG_USE_SINGLESHOT,
  PTG_USE_SINGLESHOT_INTERNAL
};
...
boolean PV_DECL pl_ptg_set_param( int16 hcam, uns32 param_id, void_ptr param_value );
...
boolean PV_DECL pl_ptg_get_enum_param(int16 hcam, int32 param_id, uns32 index,
